...
from PySide6.QtWidgets import QDateEdit, QHBoxLayout, QLabel, QLayout, QPushButton, QSizePolicy, QVBoxLayout


class Ui_PeriodForm(object):
    def setupUi(self, PeriodForm):
        if not PeriodForm.objectName():
            PeriodForm.setObjectName("PeriodForm")
        PeriodForm.resize(433, 211)
        PeriodForm.setStyleSheet(
        ...
        self.date_start.setStyleSheet("background-color: rgb(68, 68, 68);")
        ...
        self.label_3.setStyleSheet("background-color: rgb(60, 60, 60);")
        ...
        self.date_end.setStyleSheet("background-color: rgb(68, 68, 68);")
    ...
    def retranslateUi(self, PeriodForm):
        PeriodForm.setWindowTitle(QCoreApplication.translate("PeriodForm", "Form", None))
        self.label.setText(
            QCoreApplication.translate(
                "PeriodForm", "\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043f\u0435\u0440\u0438\u043e\u0434", None
            )
        )
        self.label_2.setText(QCoreApplication.translate("PeriodForm", "\u041d\u0430\u0447\u0430\u043b\u043e", None))
        self.label_3.setText(QCoreApplication.translate("PeriodForm", "\u041a\u043e\u043d\u0435\u0446", None))
        self.btn_ok.setText(QCoreApplication.translate("PeriodForm", "\u041e\u043a", None))
        self.btn_cancel.setText(QCoreApplication.translate("PeriodForm", "\u041e\u0442\u043c\u0435\u043d\u0430", None))
